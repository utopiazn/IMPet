...
function ajaxJoinFormView(){
    ...
    $.ajax({    
      ...
      success : function(data) {  
    	 $('#ContextJoinAgreement').html(data);
...
function joinCheckAll(){
	...
	if(obj.ckAll.checked == true){ 
		obj.ck1.checked = true;
		obj.ck2.checked = true;
	}else{
...
<form name="jform">
			...
			<div class="agreeArea">
				...
				<div class="agree">
					  ...
					  이 약관은&nbsp;아임펫 회사(전자상거래 사업자)가 운영하는&nbsp;아임펫 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.</p>
			...
			<div class="agreeArea">
		        ...
		        <p>
		        	...
		        	<input id="agree_privacy_check1" name="ck2" fw-filter="/1/" fw-label="개인정보 수집 및 이용 방침" fw-msg="개인정보 수집 및 이용 방침에 동의하세요" value="1" type="checkbox">
			...
			<div class="agreeArea2">	     
				<p>
					<input id="agree_privacy_check2" name="ckAll" fw-filter="/1/" fw-label="개인정보 수집 및 이용 방침" fw-msg="개인정보 수집 및 이용 방침에 동의하세요" value="1" type="checkbox" onclick="joinCheckAll();" > 				
					<label for="agree_privacy_check2">전체 동의 함</label>				    
				<p>    
			</div>	        	
			<br/><br/>
</form>		
			...
			<div class="btnArea">	
			<!--  <input TYPE="IMAGE" src="/IMPet/resources/image/SkinImg/btn_login.gif"   onclick="joinCheck();" /> -->

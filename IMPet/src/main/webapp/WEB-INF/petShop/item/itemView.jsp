...
<body>
	...
	<div class="main_itemView">
		...
		<div class="item_image">
			<div class="item_imagedetail">
				<img src="/pet/resources/goods_upload/${view.ITEM_IMG}" onerror="this.src='/pet/resources/image/noimg_130.gif'" />
			</div>
		</div>
		<form name="itemform" action="#" method="post" >
			...
			<div class="infoarea">
				...
				<div class="icon">
					<img src="/pet/resources/image/sale5.gif" />
				</div>
	...
	<div class="product_ex">
		<div id="preDetail">
			...
			<div class="de_detail">
				<p align="center"><img src="/pet/resources/goods_upload/${view.ITEM_DETAILIMG}"></p>
			</div>
		</div>
		<div id="preDetail">
			<ul class="link">
			...
			<div class="de_detail">
				<p align="center"><img src="/pet/resources/goods_upload/${view.ITEM_BASKETIMG}"></p>
			</div>
		</div>
	</div>
					...
					<div class="reply_form">
						...
						<div class="reply_write">
							<c:if test="${session_member_id == null}">
	      	 				...
	      	 				<c:if test="${session_member_id != null}">
							<div class="reply_explanation" style="align: center">
	...
	<c:forEach var="comment" items="${comment}" varStatus="stat">
     ...
     &nbsp; <img src="/pet/resources/images/goods/star_on2.gif" border="0"><img src="/pet/resources/images/goods/star_on2.gif" border="0"><img src="/pet/resources/images/goods/star_on2.gif" border="0"><img src="/pet/resources/images/goods/star_on2.gif" border="0"><img src="/pet/resources/images/goods/star_off2.gif" border="0">
      ...
      <fmt:formatDate value="${comment.REVIEW_DATE}" pattern="yy.MM.dd"></fmt:formatDate></div>
					...
					<a href="commentDelete.dog?review_no=${comment.REVIEW_NO}&items_no=${view.ITEM_NO}" class="btn btnC_01 btnP_02">
				...
				<div class="main_review">
					...
					<div class="review_image">
						<div class="review_imagedetail">
							<img src="/pet/resources/goods_upload/${view.ITEM_IMG}" onerror="this.src='/pet/resources/images/noimg_130.gif'" />
						</div>
					</div>
					<!-- 후기내용영역 -->

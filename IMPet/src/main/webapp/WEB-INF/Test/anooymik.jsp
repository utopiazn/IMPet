					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							...
							<select class="form-control" name="select" onchange="window.open(value,'_self');">
								...
								<option value ="/SIRORAGI/goods/goodsList?searchNum=2&isSearch=OUTER">CLOTHES</option>
								<option value ="/SIRORAGI/goods/goodsList?searchNum=2&isSearch=TOP">TOY</option>
								<option value ="/SIRORAGI/goods/goodsList?searchNum=2&isSearch=PANTS">FEED</option>
								<option value ="/SIRORAGI/goods/goodsList?searchNum=2&isSearch=SHOES">SNACK</option>
